...
class BarangSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $items_s2 = [
            ['nama' => 'Buku Gambar A3', 'kategori' => 5, 'beli' => 18000, 'jual' => 25000],
            ['nama' => 'Botol Susu Bayi 250ml', 'kategori' => 4, 'beli' => 55000, 'jual' => 75000],
            ['nama' => 'Pensil Warna Set 12', 'kategori' => 5, 'beli' => 28000, 'jual' => 40000],
            ['nama' => 'Diaper Rash Cream', 'kategori' => 4, 'beli' => 35000, 'jual' => 50000],
            ['nama' => 'Tas Ransel Sekolah', 'kategori' => 5, 'beli' => 95000, 'jual' => 130000],
        ];

        $items_s3 = [
            ['nama' => 'Sarung Jok Motor Anti Air', 'kategori' => 3, 'beli' => 60000, 'jual' => 85000],
            ['nama' => 'Kunci Pas Set 10pc', 'kategori' => 3, 'beli' => 110000, 'jual' => 150000],
            ['nama' => 'Sapu Ijuk Terbaik', 'kategori' => 3, 'beli' => 15000, 'jual' => 22000],
            ['nama' => 'Kain Lap Microfiber', 'kategori' => 3, 'beli' => 25000, 'jual' => 35000],
            ['nama' => 'Pel Lantai Otomatis', 'kategori' => 3, 'beli' => 65000, 'jual' => 90000],
        ];
